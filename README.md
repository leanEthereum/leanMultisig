...
With conjecture "up to capacity", current proofs with rate = 1/2 are about about ≈ 400 KiB, in which ≈ 300 KiB comes from WHIR.

- The remaining 100 KiB will be significantly reduced in the future (this part has not been optimized at all).
