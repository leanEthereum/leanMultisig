...
echo -e "\033[32m=== XMSS: 1400 sigs, log-inv-rate=1 ===\033[0m"
cargo run --release -- xmss --n-signatures 1400 --log-inv-rate 1
sleep 1s

echo -e "\033[32m=== XMSS: 1400 sigs, log-inv-rate=2 ===\033[0m"
cargo run --release -- xmss --n-signatures 1400 --log-inv-rate 2
sleep 1s
