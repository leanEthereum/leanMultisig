...
use lean_vm::{
    ...
    POSEIDON_16_COL_EFFECTIVE_INDEX_LEFT_SECOND, POSEIDON_16_COL_FLAG, POSEIDON_16_COL_INDEX_INPUT_LEFT,
    POSEIDON_16_COL_INDEX_INPUT_RES, POSEIDON_16_COL_INDEX_INPUT_RIGHT, POSEIDON_16_COL_INPUT_START,
