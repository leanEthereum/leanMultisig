...
/// `crossbeam_deque::deque::BLOCK_CAP` (private upstream; currently 63 —
...
///
/// Pushing more than `BLOCK_CAP` jobs while the arena is off rotates the tail onto
/// a system-allocated block; workers' steals then retire every older one.
pub fn flush_rayon() {
