    ...
    fn test_plonky3_compatibility() {
        ...
        */
        ...
        assert_eq!(
            vals,
            vec![
                2472545174, 2494465264, 1378828411, 2159817276, 990840178, 4077691891, 367747210, 1296698476,
                2559737505, 2863680013, 1095349934, 2118207550, 3744526966, 2462370130, 4189625406, 3376325618,
            ]
        );
    }
}
