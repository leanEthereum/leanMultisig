...
pub const KOALABEAR_RC16_EXTERNAL_INITIAL: [[KoalaBear; 16]; 8] = KoalaBear::new_2d_array([
    [
...
/// See Poseidon paper for more details: https://eprint.iacr.org/2019/458
/// Sage script used to generate these constants: https://github.com/HorizenLabs/poseidon2/blob/main/poseidon2_rust_params.sage
pub const KOALABEAR_RC16_EXTERNAL_FINAL: [[KoalaBear; 16]; 8] = KoalaBear::new_2d_array([
    [
...
/// See Poseidon paper for more details: https://eprint.iacr.org/2019/458
/// Sage script used to generate these constants: https://github.com/HorizenLabs/poseidon2/blob/main/poseidon2_rust_params.sage
pub const KOALABEAR_RC16_INTERNAL: [KoalaBear; 40] = KoalaBear::new_array([
    ...
    879151050, 2102596038, 1533193853, 1436311464, 2012303432, 839997195, 1225781098, 2011967775, 575084315,
    1309329169, 786393545, 995788880, 1702925345, 1444525226, 908073383, 1811535085, 1531002367, 1635653662,
    1585100155, 867006515, 879151050,
]);
...
/// See Poseidon paper for more details: https://eprint.iacr.org/2019/458
/// Sage script used to generate these constants: https://github.com/HorizenLabs/poseidon2/blob/main/poseidon2_rust_params.sage
pub const KOALABEAR_RC24_EXTERNAL_INITIAL: [[KoalaBear; 24]; 8] = KoalaBear::new_2d_array([
    [
...
/// See Poseidon paper for more details: https://eprint.iacr.org/2019/458
/// Sage script used to generate these constants: https://github.com/HorizenLabs/poseidon2/blob/main/poseidon2_rust_params.sage
pub const KOALABEAR_RC24_EXTERNAL_FINAL: [[KoalaBear; 24]; 8] = KoalaBear::new_2d_array([
    [
...
/// See Poseidon paper for more details: https://eprint.iacr.org/2019/458
/// Sage script used to generate these constants: https://github.com/HorizenLabs/poseidon2/blob/main/poseidon2_rust_params.sage
pub const KOALABEAR_RC24_INTERNAL: [KoalaBear; 46] = KoalaBear::new_array([
    ...
    1757946479, 1551204074, 681266718, 893435011, 403879071, 1363789863, 1662900517, 2043370, 2109755796, 931751726,
    2091644718, 606977583, 185050397, 946157136, 1350065230, 1625860064, 122045240, 880989921, 145137438, 1059782436,
    1477755661, 335465138, 1640704282, 1757946479, 1551204074, 681266718,
]);
