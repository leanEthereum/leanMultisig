...
use field::{PrimeCharacteristicRing, uint32x4_mod_add, uint32x4_mod_sub};

use super::exp_small;
use super::utils::halve_neon;
use crate::{
    FieldParameters, MontyField31, MontyParameters, PackedMontyField31Neon, PackedMontyParameters, RelativelyPrimePower,
};
...
pub trait InternalLayerParametersNeon<PMP: PackedMontyParameters, const WIDTH: usize>: Clone + Sync {
