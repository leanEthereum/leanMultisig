...
use field::{PrimeCharacteristicRing, mm512_mod_add, mm512_mod_sub};

use super::halve_avx512;
use crate::{
    FieldParameters, MontyField31, MontyParameters, PackedMontyField31AVX512, PackedMontyParameters,
    RelativelyPrimePower, apply_func_to_even_odd, packed_exp_3, packed_exp_5, packed_exp_7,
};
...
#[inline(always)]
fn add_rc_and_sbox<PMP: PackedMontyParameters, const D: u64>(val: &mut PackedMontyField31AVX512<PMP>, rc: __m512i) {
    unsafe {
...
pub trait InternalLayerParametersAVX512<PMP: PackedMontyParameters, const WIDTH: usize>: Clone + Sync {
