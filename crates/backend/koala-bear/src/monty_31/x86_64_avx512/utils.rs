...
#[inline(always)]
pub(crate) fn halve_avx512<FP: FieldParameters>(input: __m512i) -> __m512i {
    /*
    ...
    */
    unsafe {
        ...
        let half = x86_64::_mm512_set1_epi32(FP::HALF_P_PLUS_1 as i32);

        let least_bit = x86_64::_mm512_test_epi32_mask(input, ONE);
...
#[inline(always)]
pub unsafe fn mul_neg_2exp_neg_n_avx512<TAD: TwoAdicData + PackedMontyParameters, const N: u32, const N_PRIME: u32>(
    input: __m512i,
) -> __m512i {
    /*
...
/// Output may not be in canonical form but will lie in [0, P].
#[inline(always)]
pub unsafe fn mul_neg_2exp_neg_8_avx512<TAD: TwoAdicData + PackedMontyParameters, const N_PRIME: u32>(
    input: __m512i,
) -> __m512i {
    /*
        We want this to compile to:
