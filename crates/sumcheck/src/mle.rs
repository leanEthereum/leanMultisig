use p3_field::{ExtensionField, PackedFieldExtension, PackedValue, PrimeCharacteristicRing};
use p3_util::log2_strict_usize;
use rayon::prelude::*;
use utils::{
    EFPacking, PF, PFPacking, batch_fold_multilinear_in_large_field,
    batch_fold_multilinear_in_large_field_packed, pack_extension, packing_width, unpack_extension,
};
use whir_p3::utils::uninitialized_vec;

use crate::{MySumcheckComputation, SumcheckComputation};
