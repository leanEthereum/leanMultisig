...
pub fn verify_execution(
...

    {
        ...
        let (left, right) = p16_statements.split_at_mut(18);
    ...
    dbg!(debug_hash(&global_statements_base));
    dbg!(debug_hash(&global_statements_extension));
...
pub fn debug_hash<H: Hash>(h: &H) -> u64 {
