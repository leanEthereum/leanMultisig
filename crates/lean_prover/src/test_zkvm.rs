pub static FIBONNACI_PROGRAM: &str = r#"
...
mod tests {
    ...
    use crate::{prove_execution::prove_execution, test_zkvm::FIBONNACI_PROGRAM, verify_execution::verify_execution};
    use lean_compiler::*;
    use lean_vm::*;
   ...
   "#;
        ...
        let dot_product_base_ext: EF =
            dot_product(dot_product_slice_ext_a.into_iter(), dot_product_slice_base.into_iter());
        let dot_product_ext_ext: EF =
            dot_product(dot_product_slice_ext_a.into_iter(), dot_product_slice_ext_b.into_iter());
