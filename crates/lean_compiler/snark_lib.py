...
EQ_MLE_COEFFS_PTR = 73
NONRESERVED_PROGRAM_INPUT_START = 80
...
def add_be(a, b, result):
    _ = a, b, result


def add_ee(a, b, result):
    _ = a, b, result


def mul_be(a, b, result):
    _ = a, b, result


def mul_ee(a, b, result):
    _ = a, b, result


def poly_eq_be(a, b, result):
    _ = a, b, result


def poly_eq_ee(a, b, result):
    _ = a, b, result
