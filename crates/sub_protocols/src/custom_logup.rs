...
use crate::prove_generic_logup;
use crate::verify_generic_logup;
...
pub fn prove_custom_logup<EF: ExtensionField<PF<EF>>, const DIM: usize>(
    ...
    let generic = prove_generic_logup(
        prover_state,
        c,
        alpha,
        table,
    ...
    CustomLookupStatements {
        ...
        quotient_gkr_n_vars: generic.quotient_gkr_n_vars,
    }
}

#[allow(clippy::too_many_arguments)]
pub fn verify_custom_logup<EF: ExtensionField<PF<EF>>, const DIM: usize>(
    ...
    let generic = verify_generic_logup(
        verifier_state,
        c,
        alpha,
        log_memory,
