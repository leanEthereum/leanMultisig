    ...
    if n_recursions == 1:
        ...
        if n_raw_xmss == 0:
            ...
            inner_data_buf = build_inner_data_buf(
                n_sub, pubkeys_hash_expected, message, merkle_chunks_for_slot, all_tweaks,
                bytecode_hash_domsep, inner_bytecode_claim,
            )
...
@inline
def build_inner_data_buf(n_sub, pubkeys_hash, message, merkle_chunks_for_slot, all_tweaks, bytecode_hash_domsep, inner_bytecode_claim):
