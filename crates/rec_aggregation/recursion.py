...
def continue_recursion_ordered(
    ...
    for sorted_pos in unroll(0, N_TABLES):
        ...
        # Un-permute the last log_n_rows challenges from fold order (middle-out)
        # back to natural X_1..X_m order, matching the native prover/verifier.
        natural_point = natural_point_for_session(all_challenges, suffix_start, log_n_rows)
        eq_val = eq_mle_extension(bus_point, natural_point, log_n_rows)
        ...
        pcs_points[table_index].push(natural_point)
