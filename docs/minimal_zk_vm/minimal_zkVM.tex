...
\fbox{At each cycle, we commit to 8 (base) field elements:}
...
Each instruction is described by 14 field elements:
...
\begin{itemize}
    ...
    \item 6 opcode flags ($\in \{0, 1\}$): ADD, MUL, DEREF, JUMP, IS\_PRECOMPILE, PRECOMPILE\_INDEX
...
\section{Annex: simple packing of multilinear polynomials}
